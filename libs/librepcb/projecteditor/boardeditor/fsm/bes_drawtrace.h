...
class BES_DrawTrace final : public BES_Base
{
    ...
    private:
        ...
        BI_FootprintPad* findPad(Board& board, const Point& pos, GraphicsLayer& layer,
                                 NetSignal* netsignal = nullptr) const noexcept;
        BI_NetPoint* findNetPoint(Board& board, const Point& pos, GraphicsLayer& layer,
                                  NetSignal* netsignal = nullptr, BI_NetPoint* except = nullptr) const noexcept;
        BI_NetLine* findNetLine(Board& board, const Point& pos, GraphicsLayer& layer,
                                NetSignal* netsignal = nullptr, BI_NetLine* except = nullptr) const noexcept;
